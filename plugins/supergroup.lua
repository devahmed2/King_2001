...
▀▄ ▄▀                                      ▀▄ ▄▀ 
▀▄ ▄▀    BY Ahmed Alani                ▀▄ ▄▀ 
▀▄ ▄▀   BY AhmedAlani (@iraq_tachno)      ▀▄ ▄▀ 
▀▄ ▄▀ JUST WRITED BY Ahmed Salam       ▀▄ ▄▀ 
▀▄ ▄▀   orders   :    الاوامر                 ▀▄ ▄▀ 
▀▄▀▀▄▄▀▀▄▄▀▄▄▀▀▄▄▀▀▄▄▀▄▄▀▀▄▄▀▀▄▄▀▄▄▀▀▄▄▀▀▄▄▀▄▄▀▀ 
--]] 
local function check_member_super(cb_extra, success, result) 
  ...
  for k,v in pairs(result) do 
    ...
    if member_id ~= our_id then 
      ...
      save_data(_config.moderation.data, data) 
      local text = '👑 ️تــ✔ــم تـــفـــعـــيـــل 👑' 
...
local function check_member_superrem(cb_extra, success, result) 
  ...
  for k,v in pairs(result) do 
    ...
    if member_id ~= our_id then 
      ...
      save_data(_config.moderation.data, data) 
      local text = '💎 تـــ✔ــم تـــعـــطـــيـــل 💎' 
      return reply_msg(msg.id, text, ok_cb, false) 
    end 
  end 
end 
...
local function lock_group_links(msg, data, target) 
  ...
  if group_link_lock == 'yes' then 
    return 'الروابط بالفعل🎀تم قفلها👍 \n💎 معرفك : @'..msg.from.username..'\n💎 ايديك : '.. msg.from.id..'\n' 
  else 
...
local function unlock_group_links(msg, data, target) 
  ...
  if group_link_lock == 'no' then 
    return 'الروابط بالفعل🎀مفتوحه\n💎 معرفك : @'..msg.from.username..'\n💎 ايديك : '.. msg.from.id..'\n' 
  else 
    data[tostring(target)]['settings']['lock_link'] = 'no' 
    save_data(_config.moderation.data, data) 
    return 'تم فتح الروابط🎀يمكنك الارسال الان😽\n💎 معرفك : @'..msg.from.username..'\n💎 ايديك : '.. msg.from.id..'\n' 
  end 
end 
...
local function lock_group_arabic(msg, data, target) 
  ...
  if group_arabic_lock == 'yes' then 
    return 'اللغه العربيه بالفعل 🎀 تم قفلها \n💎 معرفك : @'..msg.from.username..'\n💎 ايديك : '.. msg.from.id..'\n' 
  else 
    data[tostring(target)]['settings']['lock_arabic'] = 'yes' 
    save_data(_config.moderation.data, data) 
    return 'تم️ قفل🎀 اللغه العربيه\n💎 معرفك : @'..msg.from.username..'\n💎 ايديك : '.. msg.from.id..'\n' 
  end 
end 
...
local function lock_group_membermod(msg, data, target) 
  ...
  if group_member_lock == 'yes' then 
    return 'الاضافه بالفعل🎀 تم قفلها \n💎 معرفك : @'..msg.from.username..'\n💎 ايديك : '.. msg.from.id..'\n' 
  else 
    data[tostring(target)]['settings']['lock_member'] = 'yes' 
    save_data(_config.moderation.data, data) 
  end 
  return 'تم️ قفل🎀 الاضافه\n💎 معرفك : @'..msg.from.username..'\n💎 ايديك : '.. msg.from.id..'\n' 
end 
...
local function unlock_group_sticker(msg, data, target) 
  ...
  if group_sticker_lock == 'no' then 
    return 'الملصقات بالفعل🎀 تم فتحها \n💎 معرفك : @'..msg.from.username..'\n💎 ايديك  : '.. msg.from.id..'\n' 
  else 
    data[tostring(target)]['settings']['lock_sticker'] = 'no' 
    save_data(_config.moderation.data, data) 
    return 'تم️ فتح 🎀 الملصقات\n💎 معرفك : @'..msg.from.username..'\n💎 ايديك : '.. msg.from.id..'\n' 
  end 
end 
...
local function lock_group_contacts(msg, data, target) 
  ...
  if group_contacts_lock == 'yes' then 
    return 'جهات الاتصال بالفعل🎀 تم قفلها\n💎 معرفك : @'..msg.from.username..'\n💎 ايديك  : '.. msg.from.id..'\n' 
  else 
...
local function enable_strict_rules(msg, data, target) 
  ...
  if group_strict_lock == 'yes' then 
    return 'تم بالفعل قفل جميع الاعدادات \n💎 معرفك : @'..msg.from.username..'\n💎 ايديك : '.. msg.from.id..'\n' 
  else 
...
local function disable_strict_rules(msg, data, target) 
  ...
  if group_strict_lock == 'no' then 
    return 'تم بالفعل️ فتح🎀 جميع الاعدادات \n💎 معرفك : @'..msg.from.username..'\n💎 ايديك  : '.. msg.from.id..'\n' 
  else 
        ...
        if matches[1] == 'فتح' and is_momod(msg) then 
            ...
            local msg_type = 'Video' 
                if is_muted(chat_id, msg_type..': yes') then 
                    ...
                    return '  تم بالفعل  فتح 🎀 الفيديوهات \n💎 معرفك : @'..msg.from.username..'\n💎 ايديك : '.. msg.from.id..'\n' 
                end 
            end 
            if matches[2] == 'الصور المتحركه' then 
            local msg_type = 'Gifs' 
                if is_muted(chat_id, msg_type..': yes') then 
                    ...
                    return '  تم بالفعل  فتح 🎀 الصور المتحركه \n💎 معرفك : @'..msg.from.username..'\n💎 ايديك : '.. msg.from.id..'\n' 
                end 
            end 
            if matches[2] == 'الفايلات' then 
            local msg_type = 'Documents' 
