...
if [ "$1" = "install" ]; then
  ...
  #Adding some color. By @Alani20011
   echo -e "\033[38;5;208m"
   echo -e "     > DEV : Ahmed                                          "
   echo -e "     > DEV : @Alani20011                                           "
   echo -e "     > Bot ID : DEV : @iraq_tachno                       "
   echo -e "     > Github : https://github.com/devahmed2/the3super.git    "
   echo -e "          BY Ahmed_Alani                                  \033[0;00m"
   echo -e "\e[36m"
